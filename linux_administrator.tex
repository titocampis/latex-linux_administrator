...
\subsection{Linux Services Running}
...
\begin{itemize}
    \item \textbf{ps:} the command to list processes
...
\begin{itemize}
    \item Los \textbf{tres primeros} owner permissions 
    \item Los \textbf{tres siguientes} group permissions
    \item Los \textbf{tres últimos} rest of the world permissions
\end{itemize}
\begin{itemize}
    \item \textbf{r:} read
    \item \textbf{w:} write 
...
\subsubsection{Two variants of grep usage}
\begin{enumerate}
...
\begin{figure}[H]
    \centering
    \includegraphics[scale=0.7]{pictures/image4.png}
...
\subsubsection{How to authenticate via SSH?}

\paragraph{Default user-password authentication method}
...
\paragraph{Public Key authentication method}
...
\paragraph{Generating public and private keys in our host}
...
\paragraph{Appending the Public Key into the authorized\_keys of the Server}
